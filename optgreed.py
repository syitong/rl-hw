...
def figure_2_3(runs=2000, time=100):
    bandits = []
    bandits.append(Bandit(epsilon=0, initial=5, step_size=0.1, sample_averages
        = False))
    bandits.append(Bandit(epsilon=0.1, initial=0, step_size=0.1, sample_averages
        = False))
